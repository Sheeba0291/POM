...
public class EditLeadPage extends ProjectSpecificMethods{
	...
	{
		getDriver().findElement(By.id("updateLeadForm_firstName")).clear();
		getDriver().findElement(By.id("updateLeadForm_firstName")).sendKeys(newFirstName);
	}
	
	public void updateLastName(String newLastName)
	{
		getDriver().findElement(By.id("updateLeadForm_lastName")).clear();
		getDriver().findElement(By.id("updateLeadForm_lastName")).sendKeys(newLastName);
	}
